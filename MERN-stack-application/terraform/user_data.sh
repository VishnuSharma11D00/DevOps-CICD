...
sudo apt-get install jenkins -y || { echo "Jenkins installation failed"; exit 1; }
...
docker cp DevOps-CICD/MERN-stack-application/jenkins.yaml jenkins-container:/var/jenkins_home/casc_configs/jenkins.yaml
