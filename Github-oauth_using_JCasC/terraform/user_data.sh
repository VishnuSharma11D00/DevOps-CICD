...
docker run -d -p 8080:8080 -p 50000:50000 --name jenkins-container vishnusharma11d00/jenkins-jcasc-plugin:15 || { echo "Jenkins installation failed"; exit 1; }
